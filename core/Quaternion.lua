...
function Quat:copy()
    return Quat(NATIVE.CopyQuaternion(self.handle))
end

function Quat:__add( other )
    return Quat(NATIVE.QuaternionOp(self.handle, other.handle, '+'))
end
...
function Quat:lerp( factor, other )
    return Quat(NATIVE.LerpQuaternion(self.handle, other.handle, 'l'))
end

function Quat:slerp( factor, other )
    return Quat(NATIVE.LerpQuaternion(self.handle, other.handle, 's'))
end
