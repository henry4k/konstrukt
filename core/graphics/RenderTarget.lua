...
function RenderTarget:destroy()
    Scheduler.blindCall(engine.DestroyRenderTarget, self.handle)
    self.handle = nil
end
...
function RenderTarget:setCamera( layer, name, camera )
    ...
    Scheduler.blindCall(engine.SetRenderTargetCamera, self.handle, camera.handle, layer)
...
function RenderTarget:setShaderProgramSet( shaderProgramSet )
    ...
    Scheduler.blindCall(engine.SetRenderTargetShaderProgramSet, self.handle, shaderProgramSet.handle)
